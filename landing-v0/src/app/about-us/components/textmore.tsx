  ...
  return (
    <div className="pb-10">
      ...
      <div className="flex items-center justify-between pb-6">
        <p className="text-base sm:text-lg md:text-xl font-bold">اعضای تیم</p>
        <div className="h-0.5 w-10/12 bg-gray-500 rounded-full"></div>
      </div>

      {/* Text Content */}
      <div className="text-justify leading-relaxed text-[13px] sm:text-sm md:text-base text-gray-700">
        <p>
          دگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و
          ...
          دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان
          مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل
          دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.`; // متن طولانی خودت
          رو اینجا بذار
        </p>
      </div>
    </div>

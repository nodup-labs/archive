...
const CardProjects = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl p-3 md:p-4 flex flex-col md:flex-row gap-4 md:gap-4">
      ...
      <div className="w-full pt-3 md:pt-5 flex flex-col gap-5 md:gap-7">
        ...
        <div className="flex mt-20 md:flex-row justify-between gap-3 md:gap-0 items-center">
          ...
          <button
            className=" md:hidden text-primary text-sm font-bold underline mt-2 flex items-center gap-1"

  ...
  return (
    <div className="container mx-auto px-4 md:px-0 flex flex-col gap-10">
      ...
      <div className="flex justify-between items-center">
        <p className="text-3xl font-bold ">نگارین پروژه طراحی سایت شرکتی</p>
        <p className="text-lg font-normal text-gray-500"> 1404/07/15</p>
      </div>
      <div>
      ...
      <div className="flex gap-2 items-center pb-28">
        <Badge>
          <p className="text-sm md:text-lg font-normal">#طراحی سایت</p>
        </Badge>
